    ...
    */
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        for index in 0..<tabBarViewController.viewControllers!.count {
            ...
            // Chat tab
            else if let viewController = navigationViewController.topViewController as? GroupViewController {
                viewController.username = (self.email?.componentsSeparatedByString("@"))![0]
                viewController.groupname = projectId
            }
        }
    }
